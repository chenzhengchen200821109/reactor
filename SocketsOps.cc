...
// create a non-blocking socket descriptor
...
{
    int ret = ::listen(sockfd, SOMAXCONN); // SOMAXCONN by default 128
    if (ret < 0) {
...
struct sockaddr sockets::getLocalAddr(int sockfd)
{
...
struct sockaddr sockets::getPeerAddr(int sockfd)
{
